...
export default function NotFound() {
  return (
    <main className="bg-black min-h-screen flex flex-col items-center justify-center px-8 text-center">
      ...
      <p className="font-body text-white/55 text-lg mb-8">
        This profile doesn&apos;t exist or isn&apos;t public yet.
      </p>
      <Link
        href="/"
        className="liquid-glass rounded-full px-6 py-3 text-sm font-body text-white/75 hover:text-white transition-colors"
      >
        Go home
      </Link>
    </main>
